...
@Component({
  ...
  styles: [`
    ...
    .theme-input:hover { border-color: #1f3d6e !important; }
    .theme-input:focus {
      border-color: #1f3d6e !important;
      box-shadow: 0 0 0 2px rgba(31,61,110,0.1) !important;
    }
    .theme-input-number { border-radius: 6px !important; }
    ...
    :host ::ng-deep .theme-input-number .ant-input-number:hover { border-color: #1f3d6e !important; }
    ...
    .form-divider { margin: 12px 0 !important; }
    :host ::ng-deep .form-divider .ant-divider-inner-text { display: none; }
    .form-actions {
      display: flex;
    ...
    .btn-outline:hover { border-color: #1f3d6e !important; color: #1f3d6e !important; }
