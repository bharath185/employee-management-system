...
public class ExcelHelper {
    ...
    public byte[] generateSampleExcel(Map<String, List<String>> masterDataOptions) {
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            sampleRow.createCell(29).setCellValue("YES");
            sampleRow.createCell(30).setCellValue("YES");
            ...
            sampleRow.createCell(35).setCellValue("YES");
            sampleRow.createCell(36).setCellValue("YES");
            sampleRow.createCell(37).setCellValue("YES");
            sampleRow.createCell(38).setCellValue("YES");
            sampleRow.createCell(39).setCellValue("YES");
            sampleRow.createCell(40).setCellValue("YES");
            sampleRow.createCell(41).setCellValue("YES");
            sampleRow.createCell(42).setCellValue("All documents verified");
            sampleRow.createCell(43).setCellValue("SBI");
            ...
            sampleRow.createCell(47).setCellValue("LIVE");
            sampleRow.createCell(48).setCellValue("PROCESS_A");
            sampleRow.createCell(49).setCellValue("ESIC1234567");
            sampleRow.createCell(50).setCellValue("YES");
            sampleRow.createCell(51).setCellValue("UAN123456789");
            sampleRow.createCell(52).setCellValue("PF1234567");
            sampleRow.createCell(53).setCellValue("YES");
            ...
            sampleRow.createCell(61).setCellValue("YES");
            ...
            sampleRow.createCell(75).setCellValue("");
