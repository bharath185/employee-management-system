...
public class ExcelHelper {
    ...
    public byte[] generateSampleExcel(Map<String, List<String>> masterDataOptions) {
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            // Helper: get first code from master data, or fallback
            java.util.function.BiFunction<String, String, String> first = (cat, fb) -> {
                List<String> codes = masterDataOptions.get(cat);
                return codes != null && !codes.isEmpty() ? codes.get(0) : fb;
            };
            ...
            sampleRow.createCell(4).setCellValue(first.apply("GENDER", "MALE"));
            sampleRow.createCell(5).setCellValue(first.apply("MARITAL_STATUS", "MARRIED"));
            sampleRow.createCell(6).setCellValue("Robert Doe");
            sampleRow.createCell(7).setCellValue(first.apply("F_M_H", "FATHER"));
            sampleRow.createCell(8).setCellValue(first.apply("OCCUPATION_KIN", "SALARIED"));
            sampleRow.createCell(9).setCellValue(first.apply("OCCUPATION_SUB", "MANAGER"));
            sampleRow.createCell(10).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(11).setCellValue("01/01/2024");
            sampleRow.createCell(12).setCellValue(first.apply("QUALIFICATION", "MBA"));
            sampleRow.createCell(13).setCellValue(first.apply("EDUCATION_LEVEL", "MASTERS"));
            ...
            sampleRow.createCell(17).setCellValue("123 Main Street, Hyderabad - 500001");
            sampleRow.createCell(18).setCellValue("456 Village Road, Karimnagar - 505001");
            ...
            sampleRow.createCell(23).setCellValue(first.apply("RELIGION", "HINDU"));
            sampleRow.createCell(24).setCellValue(first.apply("SOCIAL_CATEGORY", "OC"));
            sampleRow.createCell(25).setCellValue(first.apply("SOCIAL_SUBCATEGORY", "OC"));
            sampleRow.createCell(26).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(27).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(28).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(29).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(30).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(31).setCellValue("NO");
            sampleRow.createCell(32).setCellValue(first.apply("BLOOD_GROUP", "A+"));
            sampleRow.createCell(33).setCellValue("123456789012");
            sampleRow.createCell(34).setCellValue("ABCDE1234F");
            sampleRow.createCell(35).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(36).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(37).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(38).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(39).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(40).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(41).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(42).setCellValue("All documents verified");
            sampleRow.createCell(43).setCellValue(first.apply("BANK_NAME", "SBI"));
            sampleRow.createCell(44).setCellValue("12345678901");
            sampleRow.createCell(45).setCellValue("SBIN0001234");
            ...
            sampleRow.createCell(53).setCellValue(yes.apply("YES_NO"));
            sampleRow.createCell(54).setCellValue("Telugu, English");
            sampleRow.createCell(55).setCellValue("Robert Doe");
            sampleRow.createCell(56).setCellValue("9876543211");
            sampleRow.createCell(57).setCellValue("Mary Doe");
            sampleRow.createCell(58).setCellValue("9876543212");
            sampleRow.createCell(59).setCellValue("Sarah Doe");
            sampleRow.createCell(60).setCellValue("9876543213");
            sampleRow.createCell(61).setCellValue(yes.apply("YES_NO"));
            ...
            sampleRow.createCell(65).setCellValue(first.apply("RELATIONSHIP", "FRIEND"));
            ...
            sampleRow.createCell(69).setCellValue(first.apply("RELATIONSHIP", "FAMILY_FRIEND"));
            sampleRow.createCell(70).setCellValue("321 Corporate Ave, Hyderabad");
            sampleRow.createCell(71).setCellValue("9876543215");
            sampleRow.createCell(72).setCellValue(first.apply("DESIGNATION", "MANAGER"));
            sampleRow.createCell(73).setCellValue("");
            sampleRow.createCell(74).setCellValue("");
            sampleRow.createCell(75).setCellValue(first.apply("EXIT_TYPE", ""));
            sampleRow.createCell(76).setCellValue("");
